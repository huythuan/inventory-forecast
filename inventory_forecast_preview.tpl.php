...
<strong>Matched:</strong> <?php print  isset($data['matchedUnits']) ? number_format($data['matchedUnits']): 0 ;?><br>
<strong>Available:</strong> <?php print  isset($data['availableUnits']) ? number_format($data['availableUnits']) : 0 ;?><br>
